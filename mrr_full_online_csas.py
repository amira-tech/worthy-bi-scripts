...
## source: CALL_CENTER
postgres_database = config.get('CALL_CENTER', 'db')
postgres_host = config.get('CALL_CENTER', 'host')
postgres_port = config.get('CALL_CENTER', 'port')
postgres_user = config.get('CALL_CENTER', 'user')
postgres_password = config.get('CALL_CENTER', 'pass')
...
## global params
src_table_name = 'online_csas'
src_schema_name = 'public'

bucket_name = 'worthy-etl'
s3_file_name = 'etl/mrr_online_csas_tag.csv'

file_path = r'/home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_11/full/mrr_online_csas_tag.csv'
src_schema_table_name = src_schema_name+'.'+src_table_name

tgt_table_name = 'mrr_online_csas_tag'
tgt_schema_name = 'mrr'
