...
# Global parameters
create_engine_src='postgresql+psycopg2://'+postgres_user+':'+postgres_password+'@'+postgres_host+':'+postgres_port+'/'+postgres_database
src_table_name = 'consts'
src_schema_name = 'public'

tgt_table_name = 'mrr_consts_tag'
tgt_schema_name = 'mrr'

bucket_name = 'worthy-etl'
s3_file_name = '/etl/dim_consts_tag.csv'
file_path = r'/home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_10/mrr_consts_tag.csv'
...
if __name__ == '__main__':
    ...
    print("")
    read_sql_chunked(schema_table_name, connection, 1000000 * 4, 350000, file_path)
    datetime_object = datetime.now()
