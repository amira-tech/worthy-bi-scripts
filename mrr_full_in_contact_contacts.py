...
## source: DWH_INCONTACT
postgres_database = config.get('DWH_INCONTACT', 'DataBase')
postgres_host = config.get('DWH_INCONTACT', 'Host')
postgres_port = config.get('DWH_INCONTACT', 'Port')
postgres_user = config.get('DWH_INCONTACT', 'User')
postgres_password = config.get('DWH_INCONTACT', 'Pass')
...
## global params
src_table_name = 'in_contact_contacts'
src_schema_name = 'public'

bucket_name = 'worthy-etl'
s3_file_name = 'etl/mrr_in_contact_contacts_tag.csv'

file_path = r'/home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_11/full/mrr_in_contact_contacts_tag.csv'
src_schema_table_name = src_schema_name+'.'+src_table_name

tgt_table_name = 'mrr_in_contact_contacts_tag'
tgt_schema_name = 'mrr'
