...
tgt_table_name = "mrr_bids_tag"
tgt_schema_name = "mrr"

dwh_tgt_incremental_column = "updated_at"
dwh_tgt_table_name = "fact_bids"
dwh_tgt_schema_name = "public"

bucket_name = "worthy-etl"
s3_file_name = "/etl/mrr_bids_tag.csv"

file_path = "//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_1//increment//mrr_bids_tag.csv"
...
def df_load_src_data(schema_name, table_name, updated_at, db_Connection):
    sql_qur = """
                ...
                binding
                FROM {0}.{1} 
                WHERE updated_at > '{2}' AND value is not null""".format(schema_name.replace('\'', '\'\''), table_name.replace('\'', '\'\''), updated_at.replace('\'', '\'\''))
