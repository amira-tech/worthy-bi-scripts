...
## global params
src_table_name = 'in_contact_agents'
src_schema_name = 'public'

bucket_name = 'worthy-etl'
s3_file_name = 'etl/mrr_ods_in_contact_agents_tag.csv'

file_path = r'/home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_11/full/in_contact_agents_tag.csv'
src_schema_table_name = src_schema_name+'.'+src_table_name

tgt_table_name = 'mrr_in_contact_agents_tag'
tgt_schema_name = 'mrr'
