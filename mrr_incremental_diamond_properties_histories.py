...
# Global parameters
src_table_name = 'diamond_properties_histories'
src_schema_name = 'public'

tgt_table_name = 'mrr_diamond_properties_histories_tag'
tgt_schema_name = 'mrr'

dwh_tgt_incremental_column = 'updated_at'
dwh_tgt_table_name = 'ods_diamond_properties_histories'
dwh_tgt_schema_name = 'public'

bucket_name = 'worthy-etl'
s3_file_name = '/etl/mrr_diamond_properties_histories_tag.csv'

file_path = '//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_11//increment//mrr_diamond_properties_histories_tag.csv'
