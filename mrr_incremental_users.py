...
tgt_table_name = "mrr_users_tag"
tgt_schema_name = "mrr"

dwh_tgt_incremental_column = "updated_at"
dwh_tgt_table_name = "dim_users"
dwh_tgt_schema_name = "public"

bucket_name = "worthy-etl"
s3_file_name = "/etl/mrr_users_tag.csv"

file_path = "//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_1//increment//mrr_users_tag.csv"
...
def read_sql_chunked(schema_table_name, conn, nrows, chunksize, file):
    ...
    sql = """
            ...
            jewelers_program_id,
            partner_id,
            acquisition_referral_id,
            last_activity_date,
            last_communication_time,
            seller_referred_by_id,
            friendbuy_referer,
            provider,
            uid,
            image_url,
            unsubscribed,
            do_not_contact_by_phone,
            contact_preference,
            last_incoming_communication_time,
            version,
