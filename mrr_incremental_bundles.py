...
# Global parameters
src_table_name = 'bundles'
src_schema_name = 'public'

tgt_table_name = 'mrr_bundles_tag'
tgt_schema_name = 'mrr'

dwh_tgt_incremental_column = 'updated_at'
dwh_tgt_table_name = 'dim_bundles'
dwh_tgt_schema_name = 'public'

bucket_name = 'worthy-etl'
s3_file_name = '/etl/mrr_bundles_tag.csv'

file_path = '//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_1//increment//mrr_bundles_tag.csv'
...
def read_sql_chunked(schema_table_name, conn, nrows, chunksize, file):
    ...
    sql = """
            ...
            evaluation_sell,
            evaluation_loan,
            estimation_sell_lower,
            estimation_loan_lower,
            estimation_sell_upper,
            estimation_loan_upper,
            buyer_fees,
            seller_fees,
            ship_to_grading_company_id,
            arrived_at,
            store_id,
            carrier,
            sheriff_reported,
