...
cd /home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_10

python /home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_10/mrr_full_consts.py
