...
tgt_table_name = 'mrr_transfers_tag'
tgt_schema_name = 'mrr'

dwh_tgt_incremental_column = 'payment_timestamp'
dwh_tgt_table_name = 'fact_transfers'
dwh_tgt_schema_name = 'public'

bucket_name = 'worthy-etl'
s3_file_name = '/etl/mrr_transfers_tag.csv'

file_path = '//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_11//increment//mrr_incremental_transfers.csv'
