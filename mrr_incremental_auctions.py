...
# Global parameters
src_table_name = "auctions"
src_schema_name = "public"

tgt_table_name = "mrr_auctions_tag"
tgt_schema_name = "mrr"

dwh_tgt_incremental_column = "updated_at"
dwh_tgt_table_name = "fact_auctions"
dwh_tgt_schema_name = "public"

bucket_name = "worthy-etl"
s3_file_name = "/etl/mrr_auctions_tag.csv"

file_path = "//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_1//increment//mrr_auctions_tag.csv"
...
def read_sql_chunked(schema_table_name, conn, nrows, chunksize, file):
    ...
    sql = """
            ...
            sent_loosing_bid_email,
            last_minute_extend_times,
            item_type_id
