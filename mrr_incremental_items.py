...
# Global parameters
src_table_name = "items"
src_schema_name = "public"

tgt_table_name = "mrr_items_tag"
tgt_schema_name = "mrr"

dwh_tgt_incremental_column = "item_updated_at"
dwh_tgt_table_name = "dim_items"
dwh_tgt_schema_name = "public"

bucket_name = "worthy-etl"
s3_file_name = "/etl/mrr_items_tag.csv"

file_path = "//home//ec2-user//scripts//Talend_2_python//Step_1_Source_To_Mirror_Part_1//increment//mrr_items_tag.csv"
...
def read_sql_chunked(schema_table_name, conn, nrows, chunksize, file):
    ...
    sql = """
            ...
            high_value_diamond,
            user_estimation,
            last_reimbursement_date,
            bogus,
            bundle_id,
            value_category,
            shipment_cost,
            grading_by_company_id,
            arrived_at,
            reserve_price,
            trade_in,
            competition,
            current_item_location_name,
            current_location_id,
            submitted_from,
            store_id,
            was_reserve_price_changed,
            future_lead_id,
            referrer_id,
            approve_unmount_stone,
            full_reserve_price,
            negotiation_minimum_price,
            deal_date,
            reserve_price_after_buyer_fees,
            base_value_category,
            "version"
