...
if ((day == 6)); then
   echo "WEEKEND"
   python /home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_16/increment/mrr_incremental_documents.py --is_full '1'
else
   echo "WORKING DAY"
   python /home/ec2-user/scripts/Talend_2_python/Step_1_Source_To_Mirror_Part_16/increment/mrr_incremental_documents.py --is_full '0'
fi
